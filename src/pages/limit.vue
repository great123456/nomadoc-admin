...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            exportOrderList(){
              window.location.href = 'http://wallet.hxgtech.com'+'/api/admin/loan/excel?token='+`${localStorage.getItem('admin-token')}`+'&is_late=1'+'&return_at_start='+this.startTime[0]+'&return_at_end='+this.startTime[1]
            },
